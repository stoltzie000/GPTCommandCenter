...
export function resolveRepository(id:string|undefined,registry:Record<string,ResolvedRepositoryPolicy>){if(!id)return undefined;const p=registry[id];if(!p)throw new Error('REPOSITORY_NOT_ALLOWED');return Object.freeze({...p,repositoryId:id,allowedRefs:p.allowedRefs?Object.freeze([...p.allowedRefs]):undefined,allowedRefPatterns:p.allowedRefPatterns?Object.freeze([...p.allowedRefPatterns]):undefined});}
